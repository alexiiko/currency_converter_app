...
class ButtonsRightSide:
    ...
    def show_current_currency(self):
        SCREEN.blit(self.current_currency_surf, (480,310))
...
buttons_right_side = ButtonsRightSide()
